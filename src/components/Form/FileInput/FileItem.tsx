...
const fileItem = tv({
  ...
  variants: {
    state: {
      ...
      complete: {
        container: 'border border-violet-500 dark:border-violet-300/30',
      },
      error: {
        container: 'bg-error-25 border border-error-300 dark:bg-error-500/5 dark:border-error-500/30',
    ...
    >
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <button type="button" className="text-sm font-semibold text-red-700 hover:text-red-900 dark:text-error-400 dark:hover:text-red-300">
            Try again
          </button>
        </div>
