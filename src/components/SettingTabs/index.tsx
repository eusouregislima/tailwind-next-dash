...
import * as ScroolArea from '@radix-ui/react-scroll-area'
...
export const SettingsTabs = () => {
  ...
  return (
    <Tabs.Root value={currentTab} onValueChange={setCurrentTab}>
      <ScroolArea.Root className='w-full' type='scroll'>
        <ScroolArea.Viewport className='w-full overflow-x-scroll'>
        ...
        <ScroolArea.Scrollbar
          className='flex h-0.5 translate-y-1.5 touch-none select-none flex-col bg-zinc-100'
          orientation='horizontal'
        >
          <ScroolArea.Thumb className='relative flex-1 rounded-lg bg-zinc-300' />
        </ScroolArea.Scrollbar>
